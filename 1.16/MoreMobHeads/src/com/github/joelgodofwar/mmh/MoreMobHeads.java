...
public class MoreMobHeads extends JavaPlugin implements Listener {
    ...
    public boolean DropIt(EntityDeathEvent event, double chancepercent) {// TODO: DropIt
        ...
        if (itemstack != null) {
            if (debug) {
                logDebug("DI itemstack=" + itemstack.getType().toString() + " line:463");
            }
            ...
            if (debug) {
                logDebug("DI enchantmentlevel=" + enchantmentlevel + " line:465");
            }
            double enchantmentlevelpercent = ((double) enchantmentlevel / 100);
            if (debug) {
                logDebug("DI enchantmentlevelpercent=" + enchantmentlevelpercent + " line:467");
            }
            double chance = Math.random();
            if (debug) {
                logDebug("DI chance=" + chance + " line:469");
            }

            if (debug) {
                logDebug("DI chancepercent=" + chancepercent + " line:471");
            }
            chancepercent = chancepercent + enchantmentlevelpercent;
            if (debug) {
                logDebug("DI chancepercent2=" + chancepercent + " line:473");
            }
    ...
    public void onEntityDeathEvent(EntityDeathEvent event) {// TODO: EnityDeathEvent
        ...
        if (world_whitelist != null && !world_whitelist.isEmpty() && world_blacklist != null && !world_blacklist.isEmpty()) {
            if (!StrUtils.stringContains(world_whitelist, world.getName().toString()) && StrUtils.stringContains(world_blacklist, world.getName().toString())) {
                if (debug) {
                    logDebug("EDE - World - On blacklist and Not on whitelist.");
                }
                return;
                ...
                if (debug) {
                    logDebug("EDE - World - Not on whitelist.");
                }
                return;
            ...
            if (StrUtils.stringContains(world_blacklist, world.getName().toString())) {
                if (debug) {
                    logDebug("EDE - World - On blacklist.");
                }
                return;
            }
        }
        if (entity instanceof Player) {
            if (debug) {
                logDebug("EDE Entity is Player line:877");
            }
            ...
            if (entity.getKiller() instanceof Player) {
                ...
                if (debug && isNametag != null) {
                    logDebug("EDE isNametag=" + isNametag.toString());
                }
                ...
                if (entity.getKiller().hasPermission("moremobheads.mobs")) {
                    ...
                    switch (name) {
                        ...
                        case "WITHER":
                            ...
                            if (debug) {
                                logDebug("EDE Wither random=" + random + "");
                            }
                            if (DropIt(event, chanceConfig.getDouble("chance_percent.wither", defpercent))) {
                                ...
                                if (debug) {
                                    logDebug("EDE Wither_" + random + " Head Dropped");
                                }
                            }
                            break;
                        case "WOLF":
                        ...
                        case "FOX":
                            ...
                            if (debug) {
                                logDebug("EDE dafoxtype=" + dafoxtype);
                            }
                        ...
                        case "CAT":
                            ...
                            if (debug) {
                                logDebug("entity cat=" + dacat.getCatType());
                            }
                        ...
                        case "OCELOT":
                            if (DropIt(event, chanceConfig.getDouble("chance_percent." + name.toLowerCase(), defpercent))) {
                                ...
                                if (debug) {
                                    logDebug("EDE " + name + " Head Dropped");
                                }
                            }
                            if (debug) {
                                logDebug("EDE " + MobHeads.valueOf(name) + " killed");
                            }
                        ...
                        case "BEE":
                            ...
                            if (debug) {
                                logDebug("EDE daAnger=" + daAnger);
                            }
                            boolean daNectar = daBee.hasNectar();
                            if (debug) {
                                logDebug("EDE daNectar=" + daNectar);
                            }
                        ...
                        case "MUSHROOM_COW":
                            ...
                            if (debug) {
                                logDebug("EDE " + name + "_" + daCowVariant);
                            }
                        ...
                        case "PANDA":
                            ...
                            if (debug) {
                                logDebug("EDE " + name + "_" + daPandaGene);
                            }
                        ...
                        case "PARROT":
                            ...
                            if (debug) {
                                logDebug("EDE " + name + "_" + daParrotVariant);
                            }
                        ...
                        case "RABBIT":
                            ...
                            if (debug) {
                                logDebug("EDE " + name + "_" + daRabbitType);
                            }
                        ...
                        case "VILLAGER":
                            ...
                            if (debug) {
                                logDebug("EDE profession=" + daVillagerProfession);
                            }
                            if (debug) {
                                logDebug("EDE type=" + daVillagerType);
                            }
                            String daName = name + "_" + daVillagerProfession + "_" + daVillagerType;
                            if (debug) {
                                logDebug("EDE " + daName + "		 " + name + "_" + daVillagerProfession + "_" + daVillagerType);
                            }
                        ...
                        case "ZOMBIE_VILLAGER":
                            ...
                            if (debug) {
                                logDebug("EDE " + name + "_" + daZombieVillagerProfession);
                            }
                        ...
                        case "SHEEP":
                            ...
                            if (debug) {
                                logDebug("EDE " + daSheepColor + "_" + name);
                            }
                        ...
                        case "TRADER_LLAMA":
                            ...
                            if (debug) {
                                logDebug("EDE " + daTraderLlamaColor + "_" + name);
                            }
                        ...
                        default:
                            ...
                            if (debug) {
                                logDebug("EDE name=" + name + " line:1005");
                            }
                            if (debug) {
                                logDebug("EDE texture=" + MobHeads.valueOf(name).getTexture().toString() + " line:1006");
                            }
                            if (debug) {
                                logDebug("EDE location=" + entity.getLocation().toString() + " line:1007");
                            }
                            if (debug) {
                                logDebug("EDE getName=" + event.getEntity().getName() + " line:1008");
                            }
                            if (debug) {
        ...
        if (getConfig().getBoolean("wandering_trades.custom_wandering_trader", true)) {
            ...
            if (entity instanceof WanderingTrader) {
                ...
                if (getConfig().getBoolean("wandering_trades.player_heads.enabled", true)) {
                    ...
                    if (debug) {
                        logDebug("CSE playerRandom=" + playerRandom);
                    }
                    if (playerRandom > 0) {
                        if (debug) {
                        ...
                        if (debug) {
                            logDebug("CSE numOfplayerheads=" + numOfplayerheads);
                        }
                ...
                if (getConfig().getBoolean("wandering_trades.block_heads.enabled", true)) {
                    ...
                    if (debug) {
                        logDebug("CSE BH1 min=" + min + " max=" + max);
                    }
                    int blockRandom = randomBetween(min, max);
                    if (debug) {
                        logDebug("CSE blockRandom=" + blockRandom);
                    }
                    if (blockRandom > 0) {
                        if (debug) {
                        ...
                        if (debug) {
                            logDebug("CSE numOfblockheads=" + numOfblockheads);
                        }
                        HashSet<Integer> used = new HashSet<Integer>();
                        for (int i = 0; i < blockRandom; i++) {
                            ...
                            if (debug) {
                                logDebug("CSE randomBlockHead=" + randomBlockHead);
                            }
                ...
                if (getMCVersion().startsWith("1.16") || getMCVersion().startsWith("1.19")) {
                    ...
                    if (getConfig().getBoolean("wandering_trades.block_heads.enabled", true)) {
                        ...
                        if (debug) {
                            logDebug("CSE BH2 min=" + min + " max=" + max);
                        }
                        int blockRandom = randomBetween(min, max);
                        if (debug) {
                            logDebug("CSE blockRandom=" + blockRandom);
                ...
                if (getConfig().getBoolean("wandering_trades.custom_trades.enabled", false)) {
                    ...
                    if (debug) {
                        logDebug("CSE customRandom=" + customRandom);
                    }
                    if (customRandom > 0) {
                        if (debug) {
                            logDebug("CSE customRandom > 0");
                        }
                        ...
                        for (int i = 0; i < customRandom; i++) {
                            ...
                            if (debug) {
                                logDebug("CSE randomCustomTrade=" + randomCustomTrade);
                            }
                            /** Fix chance later */
                            double chance = Math.random();
                            if (debug) {
                                logDebug("CSE chance=" + chance + " line:1540");
                            }
                            if (traderCustom.getDouble("custom_trades.trade_" + randomCustomTrade + ".chance", 0.002) > chance) {
                                ...
                                if (debug) {
                                    logDebug("CSE itemstack=" + itemstack.toString());
                                }
                    ...
                    if (!(args.length >= 2)) {
                        ...
                        if (!(args.length >= 3)) {
                            ...
                            if (isInteger(args[2])) {
                                ...
                                if (debug) {
                                    logDebug("customFile=" + customFile);
                                }
                                try {
                                    traderCustom.save(customFile);
                                } catch (IOException e) {
                    ...
                    if (!(args.length >= 2)) {
                        ...
                        if (!(args.length >= 3)) {
                            ...
                            if (isInteger(args[2])) {
                                ...
                                if (debug) {
                                    logDebug("playerFile=" + playerFile);
                                }
                                try {
                                    playerHeads.save(playerFile);
                                } catch (IOException e) {
            ...
            if (args.length > 1) {
                ...
                if (args[0].equalsIgnoreCase("givemh")) {
                    if (args.length < 2) {
                        ...
                        if (debug) {
                            logDebug("TC arg1!null args.length=" + args.length);
                        }
                        if (args.length == 3) {
